...
/**
 * Flink从Kafka 队列消费数据，指定topic名称和其他一些参数, todo: topic 发现和分区发现
 *
 * @author xuanyu
 */
public class ConnectorFlinkKafkaConsumerDiscoveryDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaConsumer<String> kafkaConsumer = new FlinkKafkaConsumer<String>(
            // todo: topic 名称，使用正则表示，每个topic名称设计的时候，最好符合一条规则
            java.util.regex.Pattern.compile("flink-topic-[0-9]"),
